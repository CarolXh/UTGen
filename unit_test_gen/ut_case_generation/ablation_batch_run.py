...
JAVA_TEST_DIR= (Path(__file__).resolve().parent.parent.parent / "java_project" / "src" / "test" / "java" / "org" / "example")
...
for file_name in java_files:
    ...
    try:
        ...
        with open(Path(__file__).resolve().parent / "batch_log.txt", "a") as f:
            f.write(file_name + "\n")
        continue
